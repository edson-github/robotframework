...
class Failure(AssertionError):
    ...
    def __init__(self, message, html=False):
        ...
        """
        AssertionError.__init__(self, message if not html else f'*HTML* {message}')
...
class Error(RuntimeError):
    ...
    def __init__(self, message, html=False):
        ...
        :param html: When ``True``, message is considered to be HTML and not escaped.
        """
        RuntimeError.__init__(self, message if not html else f'*HTML* {message}')
...
class SkipExecution(Exception):
    ...
    def __init__(self, message, html=False):
        ...
        :param html: When ``True``, message is considered to be HTML and not escaped.
        """
        Exception.__init__(self, message if not html else f'*HTML* {message}')
